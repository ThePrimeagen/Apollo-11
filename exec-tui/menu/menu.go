...
func Catalog() []Entry {
	return []Entry{
		...
		{ID: "gunfire", Section: "Scenes", Title: "Gunfire", Desc: "one-shot Doom-shotgun blast — space fires: flash, seven pellets, sparks, then smoke", Pkg: "./cmd/gunfire"},
		...
		{ID: "gunfire-config", Section: "CONFIG", Title: "GUNFIRE CONFIG", Desc: "tune the shotgun blast (aim, flash, pellets, sparks, smoke)", Pkg: "./cmd/adjustgunfire/main"},
