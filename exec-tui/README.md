...
shows/        composable bills, one package per show
  ...
  lunarcloseup/  the lander close-up: arrival, fire, north-facing fall, landing on a huge moon horizon
cmd/          every runnable: editors, demos, tuners
  premiere/   the four-scene screenplay (arrival, DSKY dock, descent orbit, THE END)
  lunarcloseup/  runs the four-scene lander close-up (space past the last scene ends it)
