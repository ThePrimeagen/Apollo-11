...
shows/        composable bills, one package per show
  ...
  lunarcloseup/  the lander close-up: drifting stars, then the zoomed-in craft slides in
cmd/          every runnable: editors, demos, tuners
  premiere/   the four-scene screenplay (arrival, DSKY dock, descent orbit, THE END)
  lunarcloseup/  runs the lander close-up screenplay (space past the last scene ends it)
